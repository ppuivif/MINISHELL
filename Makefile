...
SRCS = minishell.c \
		...
		parsing_substrings.c parsing_redirections.c parsing_arguments.c	parsing_utils.c\
		...
		execution.c\
		builtin_utils.c Builtins/echo.c Builtins/pwd.c	Builtins/exit.c	Builtins/exit_utils.c	Builtins/cd.c	Builtins/env.c	Builtins/unset.c	Builtins/export.c\
		signals.c
...
SRCS += libft_utils_1.c libft_utils_2.c libft_utils_3.c libft_utils_4.c libft_utils_5.c libft_utils_6.c\
		linked_list_utils_1.c init.c free_command_line_1.c free_command_line_2.c\
		free_exec_struct.c\
