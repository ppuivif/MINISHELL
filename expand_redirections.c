...
int	get_definitive_content_of_redirections(char *content, char **definitive_content, \
int e_redirection)
{
	int		len;
	char	*extracted_line;
...
size_t	common_extract_and_expand_content_of_redirections(char *content, \
char **extracted_line)
{
	size_t	len;
...
size_t	heredoc_extract_and_expand_content_of_redirections(char *content, \
char **extracted_line)
{
	size_t	len;
